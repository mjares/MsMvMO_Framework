...
calculate_rga_number = 0;
iterations = 1000;
no_runs = [1 1];
%% System Model
model_name = "Simu2Vita_ROV";
stages = "full";  % "full" or "individual"
...
%%%%%%% LEFT OFFF HEREEEEEE!!!!
    % optimal_control_parameters = Parameters.controller; 
    for ss = 1:Config.msframework.no_stages
        ...
        Parameters.reference.stage_step_signal = Parameters.reference.step_signal(ss, :);
        ...
        %%%%%%%%%%%% AND HEREEEEE
        % optimal_control_parameters(target_parameters) = table2array(ResultsBO.best_params);
    end
